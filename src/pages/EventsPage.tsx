...
/>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 reveal">
          ...
          <div
            className={`text-xs font-semibold tracking-widest uppercase mb-4 ${isDark ? 'text-white/25' : 'text-dark-bg/25'}`}
          >
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          {events
            ...
            .filter(
              ...
              event.category==='Bootcamp & Workshop'
...
?'bg-gradient-to-r from-brand-pink to-brand-orange text-white':'bg-brand-purple/10 text-brand-purple border border-brand-purple cursor-not-allowed'
}`}
